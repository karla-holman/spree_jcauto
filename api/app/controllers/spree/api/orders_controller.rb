module Spree
  module Api
    class OrdersController < Spree::Api::BaseController
      skip_before_action :check_for_user_or_api_key, only: :apply_coupon_code, raise: false
      skip_before_action :authenticate_user, only: :apply_coupon_code, raise: false
